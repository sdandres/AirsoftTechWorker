...
def validate_login():
    password = entry_1.get().strip()  # Switched to match correct backend naming
    username = entry_2.get().strip()  # Switched to match correct backend naming
    print(f"Username entered: '{admin}'")  # Debug statement
...
def open_dashboard():
    ...
    Label(dashboard, text="Welcome to the Dashboard!", font=("Arial", 24)).pack(pady=50)
    dashboard.mainloop()
...
canvas.create_text(768.0, 350.0, anchor="nw", text="Username", fill="#000000", font=("MergeOne Regular", 24 * -1))
canvas.create_text(768.0, 432.0, anchor="nw", text="Password", fill="#000000", font=("MergeOne Regular", 24 * -1))
